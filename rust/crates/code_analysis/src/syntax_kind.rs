...
/// Converts a raw u16 value into a SyntaxKind enum variant.
///
/// # Safety
/// This uses `transmute` under the hood. The caller must ensure the u16 value
/// corresponds to a valid SyntaxKind variant.
