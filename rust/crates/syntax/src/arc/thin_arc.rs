...
mod tests {
    ...
    fn test_thin_arc_partial_eq() {
        ...
        let thin_arc4 = ThinArc::from_header_and_iter("different".to_string(), vec![1, 2, 3].into_iter());
    ...
    fn test_thin_arc_different_types() {
        ...
        assert_eq!(thin_arc2.slice(), &["hello".to_string(), "world".to_string()]);
    }
    ...
    fn test_thin_arc_memory_layout() {
        ...
        assert_eq!(std::mem::size_of::<ThinArc<String, i32>>(), std::mem::size_of::<*const ()>());
