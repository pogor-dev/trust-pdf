...
description: Learn how to use TRust PDF, a Rust-based PDF 2.0 compiler and analysis toolkit.
...
hero:
  ...
  tagline: Rust-based PDF 2.0 compiler and analysis toolkit documentation.
  image:
    file: ../../assets/houston.webp
  actions:
    - text: Green Trivia
      link: /syntax/green/trivia
      icon: right-arrow
